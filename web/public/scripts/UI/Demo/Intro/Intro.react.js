                ...
                className={ this._b }>
                    ...
                    <article
                        ...
                        <div 
                            ...
                            <p className={ this._b('AboutDescriptionParagraph') }>
                                Данная страница содержит последовательно несколько разделов, каждый из которых последовательно знакомит читателя с этапами разработки: сначала пришла <a href="#IdeaPart" className={ this._b('InternalLink') }>идея</a>, после были сформулированы <a href="#ChallengePart" className={ this._b('InternalLink') }>основные задачи</a> на проект, далее перешли к <a href="#TechPart" className={ this._b('InternalLink') }>выбору технологии</a>, разделу посвещённому созданной системе <a href="#DashboardPart" className={ this._b('InternalLink') }>созданной системе анализа</a> и разделу с итогами <a href="#Results" className={ this._b('InternalLink') }>проделанной работы</a>.
                            </p>
                        </div>
                    </article>
                    ...
                    <article
                        ...
                        <div 
                            ...
                            <p>
                                ...
                                Более остальных, меня заинтересовали предложения, с возможностями возврата части потраченных средств обратно на карточку - широко популярная в узких кругах система Cashback. Продолжив исследование, я обратился к аналогичным продуктам других банков.
                                По результатам исследования, я сделал вывод о том, что продукт, который меня заинтересовал возможно получить только у достаточно ограниченного множества банков. Тем не менее, программы каждого из них разняться. 
                            </p>
                            <p>
                            ...
                            <div 
                                ...
                                <ol 
                                    ...
                                    <li className={ this._b('ChallengeDescriptionParagraph') }>
                                        Построить простую и понятную модель представления данных для "не обладающего специфическими зананиями" пользователя
                                    </li>
                                    <li className={ this._b('ChallengeDescriptionParagraph') }>
                    ...
                    <article
                        ...
                        <div 
                            ...
                            <p>
                                Основным критерием в создании "ресурсоёмких дашбордов" является доступность этой системы для всех групп пользователей. Было решено создать веб сервер с поддержкой разных протоколов обмена данными для разных "клиентов-приложений".
                            </p>
                            <p>
                                Логика распределения запросов написана на языке NodeJS, для кластеризации данных написан специальный демон - програма обрабатывающая таймлайны в параллельных потоках. В качестве платнформы для микросервисов была выбрано решение от Docker. Приложение запущено на выделенном сервере в одном из облаков.
                            </p>
                            <p>
                                На данный момент, единственным "клиентом-приложением" для сервиса является веб интерфейс. Технологический стек на вебе: React + Redux, Data Driven Documents (D3), Webpack, и прочее.
                            </p>
                            <p>
                                Для прототипа, основным требованием было постоянное выполнение бекапов со стороны демона кластеризации для быстрого доступа к класеризованным данным со стороны "клиентов-приложений".
                            </p>
                            <p>
